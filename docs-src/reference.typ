...
typst-doc reads documentation from source files and writes Typst markup\. Each input is a file or a directory; every documented entity becomes one manual entry\. A directory contributes its recognised files in name order\.
